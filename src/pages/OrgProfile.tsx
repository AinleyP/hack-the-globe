    ...
    <div className='org-profile-page container'>
      <div className='row'>
        ...
        <div className='col-8'>
          ...
          <div className='row test'>{org.bio}</div>
          <div className='row test'>Currently Supporting:</div>
          <div className='row test'>Black Lives Matter, Asian Hate, Indigenous Rights</div>
        </div>
        <div className='col-1'>
          <div>Connect</div>
        </div>
      ...
      <div className='row'>
          <div className="col-11 test grey-banner">
          <div className='row'>
            <div className="col-6">
      ...
      <div className='row'>
          <div className="col-6">
            <h5> Information</h5>
            <p>Events helped: {org.eventsHelped}</p>
            <p>Sponsorship to date: {org.sponsorshipToDate}</p>
